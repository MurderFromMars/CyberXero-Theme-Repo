...
Then reboot to apply the full CyberXero layout. keep in mind you will need to manually select the color scheme/icons under colors and themes in plasma settings once finished as well as click edit on the breeze window decoration and add overrides if you want to hide titlebars
